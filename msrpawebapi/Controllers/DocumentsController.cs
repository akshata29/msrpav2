...
namespace msrpawebapi
{
    ...
    public class DocumentsController : ControllerBase
    {
        ...
        public DocumentsController(AppInsightsConfig appInsightsConfig, SearchConfig searchConfig, 
            BlobStorageConfig storageConfig, TelemetryClient telemetryClient)
        {
